      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        <div className="grid grid-cols-2 justify-between gap-12 py-8 sm:grid-rows-[auto_auto] md:grid-cols-4 md:grid-rows-[auto_auto] md:py-12 lg:grid-cols-[repeat(4,minmax(0,140px))_1fr] lg:grid-rows-1 xl:gap-20">
          ...
          <div className="space-y-2">
            <h3 className="text-sm font-medium text-gray-200">Eventos</h3>
          ...
          {/* 2nd block */}
          <div className="space-y-2">
            <h3 className="text-sm font-medium text-gray-200">Club</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <a
                  className="text-indigo-200/65 transition hover:text-indigo-500"
          ...
          {/* 3rd block */}
          <div className="space-y-2">
            <h3 className="text-sm font-medium text-gray-200">IT</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <a
                  className="text-indigo-200/65 transition hover:text-indigo-500"
              ...
              <ul className="inline-flex gap-1">
                <li>
                  <a
                    ...
                    href="https://twitter.com/eurielec"
                    aria-label="Twitter"
                  >
                    <svg
                ...
                <li>
                  <a
                    className="flex items-center justify-center text-indigo-500 transition hover:text-indigo-400"
                    href="https://www.instagram.com/eesteclcmadrid/"
                    aria-label="Medium"
                  >
                    <svg
                      className="h-8 w-8 fill-current"
                ...
                <li>
                  <a
                    className="flex items-center justify-center text-indigo-500 transition hover:text-indigo-400"
                    href="https://github.com/Eurielec"
                    aria-label="Github"
                  >
                    <svg
                      className="h-8 w-8 fill-current"
