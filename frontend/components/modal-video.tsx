...
export default function ModalVideo({
  ...
  return (
    <div className="relative">
      ...
      {/* Video thumbnail */}
      <button
        className="group relative flex items-center justify-center rounded-2xl focus:outline-hidden focus-visible:ring-3 focus-visible:ring-primary"
        onClick={() => {
          setModalOpen(true);
        }}
        ...
        data-aos-delay={200}
      >
        <figure className="relative overflow-hidden rounded-2xl before:absolute before:inset-0 before:-z-10 before:bg-linear-to-br before:from-black before:via-grey before:to-black/20">
          <Image
          ...
          <span className="relative flex items-center gap-3">
            ...
            >
              ...
              <defs>
                ...
                >
                  <stop stopColor="#e52a30" />
                  <stop offset={1} stopColor="#e52a30" stopOpacity=".62" />
                </linearGradient>
              </defs>
            </svg>
            <span className="text-sm font-medium leading-tight text-gray-300">
              Watch Alonso losing his dignity
