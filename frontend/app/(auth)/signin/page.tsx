"use client"; // 👈 Esto hace que el componente se ejecute en el cliente
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="pb-12 text-center">
            <h1 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,#ffffff,#e52a30,#ffffff)] bg-[length:200%_auto] bg-clip-text font-nacelle text-3xl font-semibold text-transparent md:text-4xl">
              ¡Hola!
            </h1>
          </div>
          {/* Contact form */}
          <form className="mx-auto max-w-[400px]">
              <button onClick={signInWithGoogle} className="btn relative w-full bg-linear-to-b from-white to-white bg-[length:100%_100%] bg-[bottom] text-black before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(to_right,var(--color-gray-800),var(--color-gray-700),var(--color-gray-800))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)] hover:bg-[length:100%_150%]">
